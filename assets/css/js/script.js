...
function generatePassword() {
  ...
  while(confirmLength <= 7 || confirmLength >= 128) {
      ...
      var confirmSpecialCharacter=(prompt("How many special characters would you like to add?"));
      while (confirmSpecialCharacter <=1 ) {
        alert("This Password Must Have at leat 1 Special Character. Please try again!")
      var confirmSpecialCharacter=(prompt("How many special characters would you like to add?"));
    ...
    var confirmUpperCase = confirm("Click OK to confirm if you would like to include uppercase characters");
      ...
      while(confirmUpperCase === false && confirmLowerCase === false && confirmNumericCharacter === false ) {
        ...
        var confirmNumericCharacter = confirm("Click OK to confirm if you would like to i.nclude numeric characters");    
        var confirmLowerCase = confirm("Click OK to confirm if you would like to include lowercase characters");
        var confirmUpperCase = confirm("Click OK to confirm if you would like to include uppercase characters");   
    } 
